# Wolf Engine — Quickstart

This repository contains the Wolf Engine backend (Node.js + Express) and a Next.js admin frontend.
...
Deployment: see `k8s/` manifests for a production-ready configuration. Configure secrets in Kubernetes and replace the placeholder Alertmanager webhook in `infra/prometheus/alertmanager.yml`.
# Wolf Engine

// @ts-nocheck
// utils/errors.js — Custom error hierarchy
// Standardizes error handling across the pipeline.
// All errors have a code, HTTP statusCode, and optional context.
...
// ── Helper: is this error safe to expose to the user? ─────────────────────────

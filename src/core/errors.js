...
// All errors carry: code (machine-readable), statusCode (HTTP), context (debug info).
// Use isUserFacingError() to decide whether to expose message to end users.
...
/** Returns true if the error message is safe to show to end users. */
